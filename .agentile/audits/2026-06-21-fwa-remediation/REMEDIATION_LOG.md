...
| C3-12 | LOW | DEFERRED | — | by-design trusted-recorder residual; documented. No code change (would require an identity-binding redesign across all of a Fortune-200 aerospace partner's registries) | — | covered conceptually by C3-09 attestor binding |
