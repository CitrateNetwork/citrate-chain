//! BFR-VM-1 WP-7 — regression tests for the CANCUN spec bump.
//!
//! Sprint context: BFR-VM-1 (2026-05-12). Before this fix, the
...
//! `eth_call` hex-encoded the empty bytes to `"0x"` — every BFR
...
//!
//! Diagnosis + planset:
//! - `.agentile/sprints/active/2026-05-12-bfr-vm-1-dynamic-returns/SPRINT.md`
