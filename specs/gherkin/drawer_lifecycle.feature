# BFR-00 / WP-1 — Drawer panel lifecycle Gherkin
#
...
#   - citrate_v0.01.1/gui/citrate_boeing_kit/ui/composables/drawer_panel.slint
...
Feature: Drawer panel lifecycle — slide-in detail surface
  ...
  Background:
    Given the citrate_boeing_kit drawer renderer is mounted
