# BFR-00 / WP-1 — Modal lifecycle Gherkin
#
...
#   - citrate_v0.01.1/gui/citrate_boeing_kit/ui/composables/modal.slint
...
Feature: Modal lifecycle — accept / reject / dismiss with actor capture
  ...
  Background:
    Given the citrate_boeing_kit modal renderer is mounted
