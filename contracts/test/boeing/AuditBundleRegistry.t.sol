...
contract AuditBundleRegistryTest is Test {
    ...
    function test_anchorSession_only_recorder() public {
        ...
        reg.anchorSession(BUNDLE_1, SESSION_1, SCOPE_BCA, MROOT_1, CID_1, 12);
    }

    function test_anchorSession_rejects_zero_bundle_id() public {
        vm.prank(recorder);
        vm.expectRevert(AuditBundleRegistry.ZeroBundleId.selector);
        reg.anchorSession(bytes32(0), SESSION_1, SCOPE_BCA, MROOT_1, CID_1, 12);
    }

    function test_anchorSession_emits_event_with_kind_zero() public {
        vm.expectEmit(true, true, true, true);
        emit BundleAnchored(BUNDLE_1, SESSION_1, SCOPE_BCA, 0, MROOT_1, CID_1, 12);
        vm.prank(recorder);
        reg.anchorSession(BUNDLE_1, SESSION_1, SCOPE_BCA, MROOT_1, CID_1, 12);
    }
    ...
    function test_anchorSession_rejects_duplicate_bundle_id() public {
        ...
        reg.anchorSession(BUNDLE_1, SESSION_2, SCOPE_BCA, MROOT_1, CID_1, 12);
    }
    ...
    function test_anchor_export_kind() public {
        vm.prank(recorder);
        reg.anchor(1, BUNDLE_1, SESSION_1, SCOPE_BCA, MROOT_1, CID_1, 12);
        assertEq(reg.getBundle(BUNDLE_1).kind, 1);
    }

    function test_anchor_replay_kind() public {
        vm.prank(recorder);
        reg.anchor(2, BUNDLE_1, SESSION_1, SCOPE_BCA, MROOT_1, CID_1, 12);
    ...
    function test_anchor_rejects_invalid_kind() public {
        ...
        reg.anchor(3, BUNDLE_1, SESSION_1, SCOPE_BCA, MROOT_1, CID_1, 12);
    }
    ...
    function test_anchor_kind_max_is_two() public {
        ...
        reg.anchor(255, BUNDLE_1, SESSION_1, SCOPE_BCA, MROOT_1, CID_1, 12);
    }
    ...
    function test_bundlesByScope_index_grows() public {
        ...
        reg.anchorSession(BUNDLE_1, SESSION_1, SCOPE_BCA, MROOT_1, CID_1, 12);
        vm.prank(recorder);
        reg.anchorSession(BUNDLE_2, SESSION_2, SCOPE_BCA, MROOT_1, CID_1, 5);

        bytes32[] memory list = reg.bundlesByScopeList(SCOPE_BCA);
        assertEq(list.length, 2);
        assertEq(list[0], BUNDLE_1);
        assertEq(list[1], BUNDLE_2);
        assertEq(reg.bundleCountByScope(SCOPE_BCA), 2);
    }
    ...
    function test_bundlesByScope_index_is_per_scope() public {
        ...
        assertEq(reg.bundlesByScopeList(SCOPE_BCA).length, 1);
        assertEq(reg.bundlesByScopeList(SCOPE_BDS).length, 1);
        assertEq(reg.bundlesByScopeList(SCOPE_BCA)[0], BUNDLE_1);
    ...
    function test_allBundles_grows_in_insertion_order() public {
        ...
        reg.anchorSession(BUNDLE_2, SESSION_2, SCOPE_BDS, MROOT_1, CID_1, 5);
        vm.prank(recorder);
        reg.anchor(1, BUNDLE_3, SESSION_1, SCOPE_BCA, MROOT_1, CID_1, 20);
    ...
    function test_latestSessionBundle_returns_latest() public {
        ...
        vm.prank(recorder);
        reg.anchorSession(BUNDLE_2, SESSION_1, SCOPE_BCA, MROOT_1, CID_1, 18);
    ...
    function test_is_anchored_remains_true_after_re_anchor_rejection() public {
        ...
        reg.anchorSession(BUNDLE_1, SESSION_1, SCOPE_BCA, MROOT_1, CID_1, 99);
        assertTrue(reg.is_anchored(BUNDLE_1));
