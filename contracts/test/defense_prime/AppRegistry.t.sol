...
contract AppRegistryTest is Test {
    ...
    function test_proposeApp_only_recorder() public {
        ...
        registry.proposeApp(APP_1, SCOPE_UNIT, "x", "1", owner1, ENV_1, empty, bytes32(0));
    }
    ...
    function test_proposeApp_rejects_empty_name() public {
        ...
        registry.proposeApp(APP_1, SCOPE_UNIT, "", "1", owner1, ENV_1, empty, bytes32(0));
    }
    ...
    function test_proposeApp_appears_in_byScope() public {
        _proposeAppBasic(APP_1, SCOPE_UNIT, ENV_1);
        bytes32[] memory ids = registry.byScope(SCOPE_UNIT);
    ...
    function test_proposeApp_scope_filter_isolates() public {
        ...
        assertEq(registry.byScope(SCOPE_UNIT).length, 1);
        assertEq(registry.byScope(SCOPE_BDS).length, 1);
        assertEq(registry.byScope(SCOPE_UNIT)[0], APP_1);
