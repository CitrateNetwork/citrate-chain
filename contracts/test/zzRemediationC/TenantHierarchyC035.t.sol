...
contract TenantHierarchyC035Test is Test {
    ...
    bytes32 constant BU = keccak256("DefensePrime/BU");
    bytes32 constant SITE = keccak256("DefensePrime/BU/Site");
    ...
    function setUp() public {
        ...
        admins[0] = ADMIN;
        // root max = 3 (ITAR)
        th.initRoot(ROOT, "DefensePrime", keccak256("s0"), admins, 1, 3);
