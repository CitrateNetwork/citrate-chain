...
/// @notice The on-chain backing store for the BFR-05 Provenance panel.
...
///
/// @dev BFR-05 deliverable. Composes
...
contract PartProvenanceRegistry {
    ...
    enum StepKind {
        ...
        Acceptance,     // 4 — Boeing acceptance signoff
    ...
    ///      better path (BFR-13 deliverable).
