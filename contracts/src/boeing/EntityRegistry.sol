...
/// @title EntityRegistry — Entity-type + schema registry for BFR-12.
/// @notice Per-(scope, type_id) entity-type registry with append-only
///         IDs + monotonic schema versions.
///
/// @dev Cites TLA+ spec:
///        - contracts/EntityRegistryLifecycle.tla (NEW in BFR-12)
...
///
/// Source: .agentile/sprints/active/2026-05-11-bfr-12-ontology-panel/SPRINT.md D-2
