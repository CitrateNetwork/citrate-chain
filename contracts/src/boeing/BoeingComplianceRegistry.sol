...
/// @title BoeingComplianceRegistry — Compliance posture matrix for BFR-11.
...
///
/// @dev Cites TLA+ specs:
///        - contracts/ComplianceAttestationLifecycle.tla (NEW in BFR-11)
///          — 5-state posture machine + append-only history invariants
///        - contracts/AgentDecisionLog.tla::AppendOnly — same pattern
///
/// Source: .agentile/sprints/active/2026-05-11-bfr-11-governance-panel/SPRINT.md D-3
contract BoeingComplianceRegistry {
    // ── Errors ─────────────────────────────────────────────────────────
