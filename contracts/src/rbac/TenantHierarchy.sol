...
/// @title TenantHierarchy — root of the BFR-02 RBAC access model
...
///     Enforced in `createNode` require.
///
/// @dev Per `03_RBAC_CONTRACTS.md` § 1. BFR-02 deliverable.
contract TenantHierarchy {
    ...
    /// @param display Human-readable display name (e.g., "Boeing").
