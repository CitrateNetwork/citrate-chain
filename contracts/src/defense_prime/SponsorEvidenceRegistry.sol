...
contract SponsorEvidenceRegistry {
    ...
    struct EvidenceBundle {
        ...
        bytes32 merkle_root;
        bytes32 ipfs_cid;
        bytes32 anchored_by;        // recorder identity (typically DefensePrime IT)
    ...
    /// @dev    Recorder-gated (CHAIN-B-C024): previously permissionless,
    ///         which let any anonymous account fabricate federal-sponsor
    ///         countersignatures (e.g. keccak256("DOD")) on an evidence
    ///         package they never saw, and grow the signer array without
    ///         bound. Only an authorized recorder may now anchor a
    ///         sponsor's off-chain-verified countersignature.
