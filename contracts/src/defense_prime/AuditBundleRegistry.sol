...
/// @title AuditBundleRegistry — Session-bundle anchoring for the DPF-10
///        Assistant pane.
...
///
/// @dev Recorder authorization mirrors AgentDecisionRegistryV2 (DPF-02).
///      The off-chain orchestrator (typically a Citrate node operator
///      or the assistant pane's host) holds the recorder grant.
///
/// Source: .agentile/sprints/active/2026-05-11-dpf-10-assistant-pane/SPRINT.md D-2
contract AuditBundleRegistry {
    ...
    ///         (DPF-11) and the replay flow (DPF-10b) use this.
    function anchor(
        uint8 kind,
        bytes32 bundle_id,
        bytes32 session_id,
