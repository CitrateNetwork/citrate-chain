...
/// @title DeployBfr02Rbac — Foundry deployment script for BFR-02 RBAC contracts
/// @notice Deploys all 6 BFR-02 contracts to chain 40204 (Citrate testnet)
///         in dependency order. Per `audits/bfr-02-deploy-plan.md`.
///
...
///   forge script script/DeployBfr02Rbac.s.sol \
...
contract DeployBfr02Rbac is Script {
    ...
    function run() external returns (DeployedAddresses memory addrs) {
        ...
        console2.log("=== BFR-02 RBAC deployment complete ===");
