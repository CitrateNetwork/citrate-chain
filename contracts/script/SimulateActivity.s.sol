...
/// @title SimulateActivity — one "tick" of live Boeing-network activity.
...
///
/// @dev Signer must be an authorized recorder (the BFR-DEMO deployer is, via
///      WireBfrOperators). IDs are (SIM_TICK, i)-scoped so re-runs never
///      collide. Addresses are the 2026-07-03 BFR-DEMO deploy on 40204.
///
///   Env:
...
contract SimulateActivity is Script {
    ...
    BoeingFLScopeIndex constant FL_IDX =
        BoeingFLScopeIndex(0x5c24659E68285497E43F18C429151E902abf528A);
