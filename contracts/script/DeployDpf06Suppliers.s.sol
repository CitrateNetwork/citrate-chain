...
/// @title DeployDpf06Suppliers — Foundry deployment script for DPF-06 Suppliers + MOQ
...
///      `src/defense_prime/MoqRegistry.sol:97` and
///      `src/defense_prime/SupplierRegistry.sol:106` confirms both have the
...
/// Usage:
///   # Dry-run (CI-friendly):
///   forge script script/DeployDpf06Suppliers.s.sol \
...
///   ROOT_GOVERNANCE=0x... forge script script/DeployDpf06Suppliers.s.sol \
///       --rpc-url https://rpc.citrate.ai \
...
contract DeployDpf06Suppliers is Script {
    ...
    function run() external returns (DeployedAddresses memory addrs) {
        ...
        // 1. SupplierRegistry — DefensePrime supplier lifecycle + qualification
        ...
        console2.log("=== DPF-06 Suppliers + MOQ deployment complete ===");
