...
/// @notice Creates a Boeing fleet-predictive-maintenance pool on the canonical
...
contract StartLearningPool is Script {
    ...
    function run() external {
        ...
        uint256 poolId = POOL.createPool(
            "Boeing Fleet Predictive Maintenance",
            "Federated engine-bay + structural-fatigue models across USAF operators and the Boeing depot. Raw data never leaves the operator enclave.",
            0,
            0
        );
