...
# Audit Tier — `citrate-chain`

**Classification**: **Tier 1 — full audit** before first stable (`v1.0.0`) release tag.

## Rationale

GhostDAG consensus, EVM execution, on-chain crypto, validator economics. Full security audit required before any stable release tag.
